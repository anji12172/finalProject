...
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
      ...
      <li <?=(isset($activemenu) && $activemenu == 'consultants') ? 'class="active"' : ''?>><a href="<?php echo site_url('consultants'); ?>"><i class="fa fa-money"></i> Consultants </a></li>
      <li <?=(isset($activemenu) && $activemenu == 'reports') ? 'class="active"' : ''?>><a href="<?php echo site_url('reports'); ?>"><i class="fa fa-signal"></i> Reports </a></li>
      <li <?=(isset($activemenu) && $activemenu == 'employer') ? 'class="active"' : ''?>><a href="<?php echo site_url('employer'); ?>"><i class="fa fa-money"></i> Employers </a></li>
    </ul>
