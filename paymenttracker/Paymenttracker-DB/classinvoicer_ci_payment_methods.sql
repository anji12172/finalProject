...
DROP TABLE IF EXISTS `ci_payment_methods`;
...
LOCK TABLES `ci_payment_methods` WRITE;
/*!40000 ALTER TABLE `ci_payment_methods` DISABLE KEYS */;
/*!40000 ALTER TABLE `ci_payment_methods` ENABLE KEYS */;
UNLOCK TABLES;
