...
LOCK TABLES `ci_config` WRITE;
/*!40000 ALTER TABLE `ci_config` DISABLE KEYS */;
INSERT INTO `ci_config` VALUES (1,'xyz','xyz@xyz.com','','','','','','$','',''),(2,'xyz','xyz@xyz.com','','','','','','$','','');
/*!40000 ALTER TABLE `ci_config` ENABLE KEYS */;
UNLOCK TABLES;
