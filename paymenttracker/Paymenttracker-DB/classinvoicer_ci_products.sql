...
LOCK TABLES `ci_products` WRITE;
/*!40000 ALTER TABLE `ci_products` DISABLE KEYS */;
INSERT INTO `ci_products` VALUES (1,'None','none',0.00),(2,'Software','this is used to help people',1234.00);
/*!40000 ALTER TABLE `ci_products` ENABLE KEYS */;
UNLOCK TABLES;
