...
LOCK TABLES `ci_invoices` WRITE;
/*!40000 ALTER TABLE `ci_invoices` DISABLE KEYS */;
INSERT INTO `ci_invoices` VALUES (1,1,1,'UNPAID','1',0,'','2015-10-03 00:00:00','2015-09-30');
/*!40000 ALTER TABLE `ci_invoices` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-12-19  5:54:55
